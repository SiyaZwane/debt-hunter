...
/** AC-17: a scan with zero findings is not a degenerate case — it still produces valid output. */
class AC17_ZeroFindingsValidSchemaTest {

  @Test
  void ac17_zeroFindingsProducesAnEmptyArrayAndStillValidatesAgainstTheSchema(
    ...
    assertThat(root.get("findings")).isEmpty();
